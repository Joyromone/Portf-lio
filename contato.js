const nav = document.getElementById('nav');
    ...
    const translations = {
      pt: {
        'nav.back': '← Voltar ao início', 'nav.projects': 'Projetos', 'nav.about': 'Sobre mim', 'nav.contact': 'Contato',
        'contact.label': 'Contato', 'contact.heading': 'Vamos conversar sobre seu próximo projeto?',
        ...
        'contact.email': 'E-mail', 'contact.email.desc': 'Para oportunidades, projetos ou conversas diretas',
        'contact.linkedin': 'LinkedIn', 'contact.linkedin.desc': 'Mais sobre minha trajetória e experiências',
        'contact.whatsapp': 'WhatsApp', 'contact.whatsapp.desc': 'Contato rápido para alinhamentos',
        'contact.cv': 'Currículo', 'contact.cv.desc': 'Acesse meu currículo completo',
        'contact.form.title': 'Prefere escrever? Me manda uma mensagem.', 'contact.form.btn': 'Enviar mensagem →',
        'footer.made': 'feito por uma humana 🤍',
      },
      en: {
        'nav.back': '← Back to home', 'nav.projects': 'Projects', 'nav.about': 'About me', 'nav.contact': 'Contact',
        'contact.label': 'Contact', 'contact.heading': "Let's talk about your next project?",
        ...
        'contact.email': 'Email', 'contact.email.desc': 'For opportunities, projects or direct conversations',
        'contact.linkedin': 'LinkedIn', 'contact.linkedin.desc': 'More about my background and experience',
        'contact.whatsapp': 'WhatsApp', 'contact.whatsapp.desc': 'Quick contact for alignment',
        'contact.cv': 'Resume', 'contact.cv.desc': 'Access my full resume',
        'contact.form.title': 'Prefer to write? Send me a message.', 'contact.form.btn': 'Send message →',
        'footer.made': 'made by a human 🤍',
      },
      es: {
        'nav.back': '← Volver al inicio', 'nav.projects': 'Proyectos', 'nav.about': 'Sobre mí', 'nav.contact': 'Contacto',
        'contact.label': 'Contacto', 'contact.heading': '¿Hablamos sobre tu próximo proyecto?',
        ...
        'contact.email': 'Email', 'contact.email.desc': 'Para oportunidades, proyectos o conversaciones directas',
        'contact.linkedin': 'LinkedIn', 'contact.linkedin.desc': 'Más sobre mi trayectoria y experiencias',
        'contact.whatsapp': 'WhatsApp', 'contact.whatsapp.desc': 'Contacto rápido para alineamientos',
        'contact.cv': 'Currículum', 'contact.cv.desc': 'Accede a mi currículum completo',
        'contact.form.title': '¿Prefieres escribir? Envíame un mensaje.', 'contact.form.btn': 'Enviar mensaje →',
